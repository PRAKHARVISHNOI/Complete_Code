 ...
 */
public class PlugLoadInstructionPacket {
	...
	public PlugLoadInstructionPacket() {
		super();
	}
	
	public PlugLoadInstructionPacket(String macId, String instruction) {
		super();
		this.macId = macId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PlugLoadInstructionPacket other = (PlugLoadInstructionPacket) obj;
		if (instruction == null) {
